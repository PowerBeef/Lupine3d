...
These guides describe **v0.9**, the five-sector campaign on the 160×120 Sable
build with a 24-pixel HUD.
...
| [Test report](TEST_REPORT.md) | ROM-bound v0.9 qualification and performance |
...
- [v0.8 test report](TEST_REPORT_V08.md), [beta.6 test report](TEST_REPORT_BETA6.md) and [beta.6 art contract](SABLE_OUTPOST_BETA6.md): retained release evidence.
