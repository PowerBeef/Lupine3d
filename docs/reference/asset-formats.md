...
|---|---|---|---|
| `actor_near` | 16×32 | 12 | a 242-pattern ROM cel dictionary shared by the three distances; masked into 32 OBJ patterns per bank at runtime |
| `actor_mid` | 16×16 | 12 | same |
