...
[the v0.11 report](../archive/TEST_REPORT_V11.md).
...
- **Textured walls and overlapped publication are the default**
  ...
  [performance after textures](PERFORMANCE_PHASE5.md)), since v0.11.
...
[performance after textures](PERFORMANCE_PHASE5.md), as it must: the code is
the same and only the header changed. Against v0.11's flat default
(the [v0.11 report](../archive/TEST_REPORT_V11.md)) the textured walls cost
