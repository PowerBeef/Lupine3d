...
> every packet byte. See [streamed publication](../explanation/streamed-publication.md).
...
* [The hardware checklist](../engine/hardware-checklist.md) Gate D described the legacy
