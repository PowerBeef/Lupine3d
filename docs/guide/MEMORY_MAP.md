...
Configuration `53e85d8ef99e998c489d19e5fc8b401e4a7d8dea5520d818d811cfd7dada0101`, ledger schema `lupine3d.allocations.v1`.
...
| bank 156 `$4000-$6ABA` | 10,938 | boot art and authored state | persistent |
...
| bank 248 `$4000-$8000` | 16,384 | texture row windows (three blocks per bank) | persistent |
| bank 249 `$4000-$8000` | 16,384 | texture row windows (three blocks per bank) | persistent |
| bank 250 `$4000-$8000` | 16,384 | texture row windows (three blocks per bank) | persistent |
| bank 251 `$4000-$8000` | 16,384 | texture row windows (three blocks per bank) | persistent |
| bank 252 `$4000-$8000` | 16,384 | texture row windows (three blocks per bank) | persistent |
| bank 253 `$4000-$8000` | 16,384 | texture row windows (three blocks per bank) | persistent |
| bank 254 `$4000-$8000` | 16,384 | texture row windows (three blocks per bank) | persistent |
| bank 255 `$4000-$8000` | 16,384 | texture row windows (three blocks per bank) | persistent |
...
| `$C8DE-$C8DF` | 1 | first pattern of the HBlank transfer in flight | composition through publication |
...
| `$D130-$D138` | 8 | boundary tile outline masks | one composed tile |
| `$D140-$D148` | 8 | snapshot camera | persistent |
| `$D170-$D1F0` | 128 | run row-window caches | one composed column |
| `$D200-$D2A0` | 160 | ray tops/styles | persistent |
| `$D2A0-$D2F0` | 80 | ray texture coordinates (anchor packets excluded) | persistent |
...
| `$DF20-$DF35` | 21 | wall fixture projection scratch | entity rendering |
| `$DF42-$DF56` | 20 | physical validity bits (reserved) | persistent |
| `$DF60-$E000` | 160 | physical-pixel texture coordinates (physical depth excluded) | persistent |
