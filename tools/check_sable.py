...
def check(output,snapshot_mode='check'):
    ...
    # 220 actor, drop, effect and fixture patterns, then two per item cel.
    assert len(b.make_entity_tiles())==(220+2*len(b.ITEM_CEL_NAMES))*16 and len(b.hud_assets()[0])<=96*16
