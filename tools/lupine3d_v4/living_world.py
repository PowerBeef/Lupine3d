...
def emit_entity_projection(a: Assembler) -> None:
    ...
    # Q5 depth and perspective X = 80 + lateral*127/forward.
    ...
    a.label("entity_lateral_abs_ready"); a.ld_r_r("b", "a"); a.ld_r_n("c", 127); a.call("mul_u8")
    ...
    a.ld_a_abs(ENTITY_FORWARD); a.cp_n(48); a.ld_r_n("a", 0); a.jr("entity_lod_ready", "c"); a.inc_r("a")
    a.label("entity_lod_ready"); a.ld_abs_a(SENTINEL_LOD)
    ...
    a.label("project_visibility_store"); a.ld_abs_a(SENTINEL_VISIBLE); a.ret()
    ...
    a.sub_n(4); a.ld_abs_a(ENTITY_TMP_L); a.ld_r_n("a", 4); a.ld_abs_a(ENTITY_TMP_H)
    ...
    a.ld_a_abs(SENTINEL_DEPTH); a.cp_r("b"); a.jr("entity_column_visible_yes", "c")
    a.label("entity_strip_next")
    a.ld_a_abs(ENTITY_TMP_L); a.add_a_n(2); a.ld_abs_a(ENTITY_TMP_L)
    a.ld_a_abs(ENTITY_TMP_H); a.dec_r("a"); a.ld_abs_a(ENTITY_TMP_H); a.jr("entity_strip_depth_loop", "nz")
    a.xor_r("a"); a.ret()
    a.label("entity_column_visible_yes"); a.ld_r_n("a", 1); a.ret()
...
def emit_world_update(a: Assembler) -> None:
    ...
    a.ld_r_r("b", "a"); a.ld_a_abs(SENTINEL_YH); a.ld_r_r("c", "a"); a.call("map_cell_bc"); a.or_r("a"); a.ret("nz")
...
def emit_movement_v6(a: Assembler) -> None:
    ...
    for address, skip in ((COLLIDE_LOW, "move6_x_blocked"), (COLLIDE_HIGH, "move6_x_blocked")):
        a.ld_a_abs(COLLIDE_EDGE); a.ld_r_r("b", "a"); a.ld_a_abs(address); a.ld_r_r("c", "a"); a.call("map_cell_bc"); a.or_r("a"); a.jr(skip, "nz")
    ...
    for address, skip in ((COLLIDE_LOW, "move6_y_blocked"), (COLLIDE_HIGH, "move6_y_blocked")):
        a.ld_a_abs(address); a.ld_r_r("b", "a"); a.ld_a_abs(COLLIDE_EDGE); a.ld_r_r("c", "a"); a.call("map_cell_bc"); a.or_r("a"); a.jr(skip, "nz")
...
def emit_reprojection(a: Assembler) -> None:
    ...
    a.label("stat_isr")
    a.push("af"); a.xor_r("a"); a.ldh_n_a(SCX); a.pop("af"); a.reti()
