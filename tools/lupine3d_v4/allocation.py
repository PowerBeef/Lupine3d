...
def memory_ledger(layout, code_end, resident_end, boot_bytes, raw_ray_bytes=0):
    ...
    rows = [
        ...
        *([] if l.SEGMENT_TABLE_ROM_BANK in (l.TEXTURE_WINDOW_BANKS if l.TEXTURED_WALLS else ()) else
        ...
        A("WRAM0", l.ADMISSION_RECORDS, l.ADMISSION_RECORDS_END, "atomic actor admission records", "entity rendering, no yields"),
        ...
        A("WRAM1", l.ADMISSION_COUNT, l.ADMISSION_DISTANCE_LOD + 1, "atomic actor admission scalars", "entity rendering, no yields"),
